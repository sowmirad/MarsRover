...
move_uploaded_file($filetmp,$filepath);
 $sql= "INSERT INTO PERSON (ID,Firstname, Lastname, Middlename, Address, Gender, Age, Score, Remarks,Imagename, Imagepath, Imagetype) VALUES ('','$fname','$lname','$mname','$address','$gender','$age','$scores','$remarks','$filename','$filepath','$filetype')";
